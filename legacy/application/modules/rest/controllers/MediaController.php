...
class Rest_MediaController extends Zend_Rest_Controller
{
    ...
    public function getAction()
    {
        ...
        try {
            //CcFiles::concateTriggerSound("TuneURL- (4).mp3");
            $this->getResponse()
                ->setHttpResponseCode(200)
    ...
    {   
        ...
        try {
            ...
            if (isset($requestData['isConcat'])) {
                $sanitizedFile = CcFiles::concateTriggerSound($requestData['targetFileName']);
            } else {
