...
class Application_Service_MediaService
{
    ...
    public static function importFileToLibrary(
        ...
        // if (!file_exists($importedStorageDirectory . '/Audio_trigger1.wav')) {
        //     if (@copy(Config::getStoragePath() . '/imported/' .'/Audio_trigger1.wav', $importedStorageDirectory . '/Audio_trigger1.wav') === false) {
        //         throw new Exception("Failed to copy Audio_trigger1.wav");
        //     }
        // }
    ...
    public static function notifiyAnalyzer(
        $triggerFilePath,
        $audioTrackPath
    ) {
